...
int categorize(int signal){
  int cat;
  if( signal == 24 ) cat = 0;
  else if( signal == 20) cat = 1;
  else if( signal == 18) cat = 2;
  else if( signal == 17) cat = 3;
  else if( signal == 12) cat = 4;
  else if( signal == 10) cat = 5;
  else if( signal == 9) cat = 6;
  else if( signal == 6) cat = 7;
  else if( signal == 5) cat = 8;
  else if( signal == 3) cat = 9;
  else cat = 10;
  return cat;
}
...
//  }
  //LorentsVector
  TLorentzVector jet1, jet2, jet3, jet4, jet5, addbjet1, addbjet2;
...
void ana_ttbb_j5(){
  ...
  //nJets >= 6
  auto df_goodjet = df_goodlepton.Filter("ngoodjets >= 5", "Events with at least 5 goodjets");
...
////  df_cat6.Snapshot("catetory_6", "ttbb_invmasstest.root", {"category", "jet1_pt", "jet1_eta", "jet1_btag", "jet1_e", "jet2_pt", "jet2_eta", "jet2_btag", "jet2_e", "jet3_pt", "jet3_eta", "jet3_btag", "jet3_e", "jet4_pt", "jet4_eta", "jet4_btag", "jet4_e", "deltaR_12", "deltaR_13", "deltaR_14", "deltaR_23", "deltaR_24", "deltaR_34", "lepton_pt", "lepton_eta", "lepton_e", "deltaR_lepj1", "deltaR_lepj2", "deltaR_lepj3", "deltaR_lepj4"}, opts);
  ...
  df_bjet.Snapshot("dnn_input", "ttbb_j5_m2_test.root", {"signal", "category"});
